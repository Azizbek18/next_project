  ...
  <div className="container py-[40px] max-w-[1280px] mx-auto ">
    ...
    <div className="">
      <div className="flex justify-between ">
        <h3 className='w-[50%] font-poppins font-[600] text-[44px] leading-[56px] tracking-[-3%] '>
          The energy of a start-up combined with 30 years of experience.
        </h3>
        <p
          className='w-[50%] font-poppins font-[500] py-[30px] text-[#1D3444] text-[20px] leading-[30px] tracking-[0%] '>
      ...
      <div className="flex justify-between py-[60px] ">
        <div className="">
          <h4 className={`${inter.className} font-[700] mb-2 text-[36px] text-[#F58A07] leading-[50px] tracking-[0px]
            `}>
            15+
          </h4>
        ...
        <div className="">
          <h4 className={`${inter.className} mb-2 font-[700] text-[36px] text-[#F58A07] leading-[50px] tracking-[0px]
            `}>
            500+
          </h4>
          <h4 className='font-poppins font-[600] text-[24px] leading-[107%] tracking-[-3%] '>
    ...
    <div className="flex relative  justify-between items-center py-[60px] ">
      <div className="w-[50%] ">
        <h2 className='font-poppins text-[#0D1317] py-[10px] font-[700] text-[48px] leading-[56px] tracking-[-3%] '>
          We want to get local identification in every corner of the world in this era of global citizenship.
        </h2>
        <p className='font-poppins py-[10px] mb-[15px] font-[500] text-[18px] leading-[30px] tracking-[0%]'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Curabitur sit amet eros blandit, hendrerit
          elit et, mattis <br /> purus. Vivamus commodo suscipit tellus et <br /> pellentesque.
        </p>
      </div>
      <div className=" w-[40%] h-[550px]  rounded-[20px] overflow-hidden ">
        <div
          className="bg-[#F58A07] bottom-9 right-[-20px] absolute z-10 w-[200px] h-[200px] rounded-[20px] mix-blend-multiply ">
        </div>
