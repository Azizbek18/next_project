...
<div className='bg-[#063255] relative '>
  <img className='absolute left-0 w-[40px]  bottom-0' src="/images/Footer.svg" alt="Footer photo" />
  <img className='absolute right-0 w-[40px] top-10 ' src="/images/Bezak.svg" alt="Footer photo" />
  <div className="container max-w-[1280px] mx-auto py-[60px]">
    <div className="flex justify-between">
      ...
      <div className="flex flex-col gap-6 ">
        ...
        <ul className='flex flex-col gap-2'>
          ...
          <li>
            <Link className="font-poppins text-white font-medium text-base leading-[100%] tracking-normal" href='/blog'>
            Blog
            </Link>
          </li>
        </ul>
      ...
      <div className="flex flex-col w-[300px] gap-6 ">
        ...
        <form className='flex mt-1 gap-3 flex-col' action="#">
          <input className='bg-white rounded-[30px] outline text-[#505050] w-full h-[45px] px-[18px] text-[16px] font-[500] '
    ...
    <div className="flex justify-between mt-[65px] ">
        <h4 className='font-[500] text-white text-[16px] '>
